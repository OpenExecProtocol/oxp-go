...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Tools.List(context.Background(), oxp.ToolListParams{})
	if userAgent != fmt.Sprintf("Oxp/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Tools.List(context.Background(), oxp.ToolListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Tools.List(cancelCtx, oxp.ToolListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Tools.List(deadlineCtx, oxp.ToolListParams{})
		if err == nil {
